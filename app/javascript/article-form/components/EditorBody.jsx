  ...
  return (
    ...
    >
      ...
      <TinyMceEditor
        ...
        onChange={() => {
          // Use editorRef to access the editor element and sync that with mention autocomplete maybe?
          // For markdown see https://www.tiny.cloud/docs/plugins/opensource/textpattern/
