FROM quay.io/forem/ruby:3.0.4 as base
...
ENV BUNDLER_VERSION=2.2.33 BUNDLE_SILENCE_ROOT_WARNING=true BUNDLE_SILENCE_DEPRECATIONS=true
...
ENV BUNDLER_VERSION=2.2.33 BUNDLE_SILENCE_ROOT_WARNING=1
RUN gem install -N bundler:"${BUNDLER_VERSION}"
